...
════════════════════════════════════════════════════════ */
const Auth = {
  /* Cherche un user dans DB.users par son id ou nom.prenom.date */
  find(username) {
...
════════════════════════════════════════════════════════ */
const Demandes = {
  /* Nombre de demandes en attente — utilisé dans le dashboard admin */
  async nbEnAttente() {
    const demandes = await SupabaseDB.getDemandesCompte('en_attente');
